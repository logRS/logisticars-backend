...
class UserController {
  async getById(req, res, next) {
    logger
      ...
      .info("UsuarioController > getById() | Getting user by id");
  ...
  async editUserById(req, res, next) {
    logger
      .child({ caller: res.caller })
      .info("UsuarioController > editUserById() | Editing user by id");
  ...
  async deleteUserById(req, res, next) {
    logger
      .child({ caller: res.caller })
      .info("UsuarioController > deleteUserById() | Deleting user by id");
  ...
  async getAll(_req, res) {
    logger
      .child({ caller: res.caller })
      .info("UsuarioController > getAll() | Getting all users");
